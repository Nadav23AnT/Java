...
public class Congruent
{
    public static void main (String[ ] args )
    {
        ...
        double rib1 =  Math.sqrt(Math.pow(x1-x2, NUM) + Math.pow(y1-y2, NUM)); 
        // will be the distance between the point 1 - 2
        double rib2 =  Math.sqrt(Math.pow(x2-x3, NUM)+ Math.pow(y2-y3, NUM)); 
        // will be the distance between the point 2 -3
        double rib3 =  Math.sqrt(Math.pow(x1-x3, NUM) + Math.pow(y1-y3, NUM)); 
        ...
        System.out.println("The second triangle is ("+ x4+", "+ y4+
            ") ("+x5+", "+y5+") ("+x6+", "+ y6+")");
        // Prints user coordinates
